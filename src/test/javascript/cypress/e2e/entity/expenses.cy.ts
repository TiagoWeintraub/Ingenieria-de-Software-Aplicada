...
describe('Expenses e2e test', () => {
  ...
  const expensesSample = { description: 'Concrete', amount: 64013, date: '2025-06-24T20:18:24.167Z' };
  ...
  describe('new Expenses page', () => {
    ...
    it('should create an instance of Expenses', () => {
      cy.get(`[data-cy="description"]`).type('Games red Home').should('have.value', 'Games red Home');

      cy.get(`[data-cy="amount"]`).type('835').should('have.value', '835');

      cy.get(`[data-cy="date"]`).type('2025-06-24T20:17').blur().should('have.value', '2025-06-24T20:17');
